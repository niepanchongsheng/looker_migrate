view: uac_report_gas {
  ...
  measure: CostNonInstalls   {
    ...
    type: number
    sql: sum(${TABLE}.CostNonInstalls)  ;;
  }

  measure: conversions   {
    label: "conversions"
    type: number
    sql: sum(${TABLE}.conversions)  ;;
  }

  measure: view_through_conversions    {
    label: "view_through_conversions"
    type: number
    sql: sum(${TABLE}.view_through_conversions)     ;;
  }
  ...
  measure: installs_adjusted     {
    ...
    type: number
    sql: sum(${TABLE}.installs_adjusted)    ;;
  }
